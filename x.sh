...
#find content_pub -name cover_* -exec cp {} ./docs/user1/img  \;
...
#mkdir -p docs_priv/user1/img

#
find content_priv -name cover_* -exec cp {} ./docs_priv/img            \;
#find content_priv -name cover_* -exec cp {} ./docs_priv/user1/img \;
